...
function PostProduct() {
  ...
  const handleSubmit = async () => {
    ...
    const productData = {
      name: name,
      subcategoryid: subcategory, // This should be selected dynamically
      userid: 3, // Example user ID, replace with actual user data
      description: description,
      quantity: quantity,
      price: price,
      color: "Red", // Can be dynamically set if needed
      picname: mainImage, // Send only the main image to the API
    };
    ...
    try {
      ...
      if (response.ok) {
        ...
        // You can save any other data locally if needed (like images)
